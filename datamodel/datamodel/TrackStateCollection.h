...
//  TrackStateCollection(TrackStateVector* data, int collectionID);
  ...
  const std::array<double,arraysize> Location() const;
  template<size_t arraysize>  
  const std::array<double,arraysize> Omega() const;
  template<size_t arraysize>  
  const std::array<double,arraysize> D0() const;
  template<size_t arraysize>  
  const std::array<double,arraysize> Z0() const;
...
template<size_t arraysize>
const std::array<double,arraysize> TrackStateCollection::Location() const {
...
template<size_t arraysize>
const std::array<double,arraysize> TrackStateCollection::Omega() const {
  std::array<double,arraysize> tmp;
  auto valid_size = std::min(arraysize,m_entries.size());
  for (unsigned i = 0; i<valid_size; ++i){
...
template<size_t arraysize>
const std::array<double,arraysize> TrackStateCollection::D0() const {
  std::array<double,arraysize> tmp;
  auto valid_size = std::min(arraysize,m_entries.size());
  for (unsigned i = 0; i<valid_size; ++i){
...
template<size_t arraysize>
const std::array<double,arraysize> TrackStateCollection::Z0() const {
  std::array<double,arraysize> tmp;
  auto valid_size = std::min(arraysize,m_entries.size());
  for (unsigned i = 0; i<valid_size; ++i){
