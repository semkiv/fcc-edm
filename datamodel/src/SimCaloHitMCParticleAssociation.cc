...
SimCaloHitMCParticleAssociation::SimCaloHitMCParticleAssociation(double Fraction) : m_obj(new SimCaloHitMCParticleAssociationObj()){
 m_obj->acquire();
...
SimCaloHitMCParticleAssociation::operator ConstSimCaloHitMCParticleAssociation() const {return ConstSimCaloHitMCParticleAssociation(m_obj);}
  ...
  const double& SimCaloHitMCParticleAssociation::Fraction() const { return m_obj->data.Fraction; }
...
void SimCaloHitMCParticleAssociation::Fraction(double value){ m_obj->data.Fraction = value;}
