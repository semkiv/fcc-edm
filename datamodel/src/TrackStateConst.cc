...
ConstTrackState::ConstTrackState(double Location,double Omega,double D0,double Z0) : m_obj(new TrackStateObj()){
 m_obj->acquire();
...
ConstTrackState::~ConstTrackState(){
  ...
  const double& ConstTrackState::Location() const { return m_obj->data.Location; }
  const double& ConstTrackState::Omega() const { return m_obj->data.Omega; }
  const double& ConstTrackState::D0() const { return m_obj->data.D0; }
  const double& ConstTrackState::Z0() const { return m_obj->data.Z0; }
