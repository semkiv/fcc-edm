...
ConstSimCaloHitMCParticleAssociation::ConstSimCaloHitMCParticleAssociation(double Fraction) : m_obj(new SimCaloHitMCParticleAssociationObj()){
 m_obj->acquire();
...
ConstSimCaloHitMCParticleAssociation::~ConstSimCaloHitMCParticleAssociation(){
  ...
  const double& ConstSimCaloHitMCParticleAssociation::Fraction() const { return m_obj->data.Fraction; }
