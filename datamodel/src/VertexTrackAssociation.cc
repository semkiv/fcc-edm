...
VertexTrackAssociation::VertexTrackAssociation(double Weight) : m_obj(new VertexTrackAssociationObj()){
 m_obj->acquire();
...
VertexTrackAssociation::operator ConstVertexTrackAssociation() const {return ConstVertexTrackAssociation(m_obj);}
  ...
  const double& VertexTrackAssociation::Weight() const { return m_obj->data.Weight; }
...
void VertexTrackAssociation::Weight(double value){ m_obj->data.Weight = value;}
