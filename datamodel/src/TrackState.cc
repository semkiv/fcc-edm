...
TrackState::TrackState(double Location,double Omega,double D0,double Z0) : m_obj(new TrackStateObj()){
 m_obj->acquire();
...
TrackState::operator ConstTrackState() const {return ConstTrackState(m_obj);}
  ...
  const double& TrackState::Location() const { return m_obj->data.Location; }
  const double& TrackState::Omega() const { return m_obj->data.Omega; }
  const double& TrackState::D0() const { return m_obj->data.D0; }
  const double& TrackState::Z0() const { return m_obj->data.Z0; }

void TrackState::Location(double value){ m_obj->data.Location = value;}
void TrackState::Omega(double value){ m_obj->data.Omega = value;}
void TrackState::D0(double value){ m_obj->data.D0 = value;}
void TrackState::Z0(double value){ m_obj->data.Z0 = value;}
