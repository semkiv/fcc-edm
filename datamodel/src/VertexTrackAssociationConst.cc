...
ConstVertexTrackAssociation::ConstVertexTrackAssociation(double Weight) : m_obj(new VertexTrackAssociationObj()){
 m_obj->acquire();
...
ConstVertexTrackAssociation::~ConstVertexTrackAssociation(){
  ...
  const double& ConstVertexTrackAssociation::Weight() const { return m_obj->data.Weight; }
